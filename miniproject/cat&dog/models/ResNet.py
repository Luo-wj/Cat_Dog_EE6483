...
class ResNet(nn.Module):
    def __init__(self):
        super().__init__()
        self.layer1 = Res_Conv_Block(in_ch=3, out_ch=16, stride=2)
        self.layer2 = Res_Conv_Block(in_ch=16, out_ch=32, stride=2)
        self.layer3 = Res_Conv_Block(in_ch=32, out_ch=64, stride=2)
        self.layer4 = Res_Conv_Block(in_ch=64, out_ch=128, stride=2)
        self.layer5 = Res_Conv_Block(in_ch=128, out_ch=256, stride=2)
